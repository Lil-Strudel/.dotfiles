...
local RESOURCES_DIR = base_path .. 'ui/bar/resources/battery/'
...
local function worker(user_args)
    ...
    local path_to_icons = args.path_to_icons or RESOURCES_DIR 
    ...
    local warning_msg_icon = args.warning_msg_icon or RESOURCES_DIR .. 'spaceman.jpg'
