...
```
sudo apt install neovim xclip yadm firefox-est kitty zsh gnupg2 curl build-essential unzip eza tmux ripgrep fonts-noto-cjk fonts-noto-color-emoji pavucontrol fzf rofi polybar feh network-manager playerctl brightnessctl
```
